...
abstract class $GameCopyWith<$Res> {
  ...
  @useResult
  $Res call({String imageName, String title, String description});
}
...
class _$_Game with DiagnosticableTreeMixin implements _Game {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Game(imageName: $imageName, title: $title, description: $description)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, imageName, title, description);
...
abstract class _Game implements Game {
  const factory _Game(
      ...
      required final String description}) = _$_Game;
